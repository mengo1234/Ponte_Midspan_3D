...
const MODELS = {
  ...
  nobars: {
    ...
    source: 'Telaio, traverse, diagonali e stiffener interni rimossi · base simmetrizzata (lato destro specchiato sul sinistro)',
    status: 'base simmetrica · pilastri lisci',
    width: '160 mm',
    length: '104,9 mm',
    height: '77,1 mm',
    faces: '151.706',
