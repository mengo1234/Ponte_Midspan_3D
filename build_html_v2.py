...
const MODELS = {
  ...
  nobars: {
    ...
    source: 'Telaio, traverse, diagonali e 2 stiffener verticali interni rimossi · piastra bulloni resa quadrato pieno',
    status: '0 bordi aperti · pilastri lisci all’interno',
    width: '160 mm',
    length: '104,9 mm',
    height: '77,3 mm',
    faces: '183.947',
